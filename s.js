...
jQuery(document).ready(function(){
    ...
    jQuery("#amazingaudioplayer-8").amazingaudioplayer({
        ...
        tracklistarrowimage:"https://1.top4top.net/p_1249budal2.png",
        ...
        loopimage:"https://4.top4top.net/p_12493irwf5.png",

        prevnextimage:"https://2.top4top.net/p_1249opjxs3.png",
        ...
        volumeimage:"https://6.top4top.net/p_124914y3y1.png",
        ...
        playpauseimage:"https://3.top4top.net/p_1249gtzzt4.png",
        
        DownloadShow:true,
        
		Downloadimage:"https://5.top4top.net/p_12499g66a6.png",
		
		Downloadimageheight:24,
		
		Downloadimagewidth:24,
...
(function($) {
    ...
    $.fn.amazingaudioplayer = function(options) {
        ...
        var PlayerSkin = function(amazingPlayer, container, options, id) {
            ...
            if (this.options.showtitle || this.options.showinfo) {
                ...
                if (this.options.showinfo) {
                    ...
                    this.container.on("amazingaudioplayer.updateinfo", function(event, data) {
                        ...
                        Names = data.title;
                        document.querySelector('#titlei').innerHTML = "Playlist - " + data.title;
                    });
            ...
            if (this.options.DownloadShow) {
                var $download = $("<div class='amazingaudioplayer-downloads'></div>");
                 $download.appendTo($bar).css({
                       display: "block",
                       width: this.options.Downloadimagewidth,
                       height: this.options.Downloadimageheight,
                       "background-image": 'url("' + this.options.Downloadimage + '")',
			     ...
			     $download.click(function() {
                    ...
                    link.href= Don;
					link.target = "_blank";
                    link.download = Names.substr(0, 28);
					link.click();
                ...
                if (this.options.showvolumebar) {
                    ...
                    var adjustVolumeBar = function(e) {
                        ...
                        if (instance.options.volumebarposition == "top" || instance.options.volumebarposition == "bottom") {
                            vol = 1 - (e0.pageY - instance.$volumeBarAdjust.offset().top) /
            ...
            if (this.options.showtracklist) {
                ...
                this.container.on("amazingaudioplayer.switched", function(event, data) {
                    ...
                    if (data.current >= 0) {
                        ...
                        if (!instance.options.tracklistscroll &&
                            instance.options.tracklistitem < instance.amazingPlayer.elemLength) {
                ...
                if (this.options.tracklistitem < this.amazingPlayer.elemLength) {
                    ...
                    if (this.options.tracklistscroll) {
                        var totalheight = this.$tracks.height();
                        var visibleheight =
                            this.$tracklist.height();
        ...
        AmazingAudioPlayer.prototype = {
            ...
            init: function(instance) {
                ...
                var firstId = 0;
                if ("firstaudioid" in params && !isNaN(params["firstaudioid"]) && params["firstaudioid"] >= 0 && params["firstaudioid"] < instance.elemLength) firstId = parseInt(params["firstaudioid"]);
                var uelsit = window.location.toString();
                
               
                var getid =  uelsit.split("\?id=")
                if(getid.length > 1)
                {
                    if(getid[1] == "")
                    {
                        history.pushState(null, null, "?id=" + firstId);
                        instance.audioRun(firstId, false);
                    }
                    else
                    {
                        history.pushState(null, null, "?id=" + getid[1]);
                         instance.audioRun(getid[1], false);
                    }
                }
                else 
                {
                ...
                if ("autoplayaudio" in params)
                    if (params["autoplayaudio"] ==
                        "1") instance.options.autoplay = true;
            ...
            playAudio: function(startTime) {
                ...
                this.container.trigger("amazingaudioplayer.played", this.currentItem);
                history.pushState(null, null, "?id=" + this.currentItem);
                if (this.options.stopotherplayers) this.stopOthers()
            },
            pauseAudio: function() {
        ...
        for (var key in options)
            ...
            var defaultOptions = {
				...
				Downloadimageheight:18,
				Downloadimagewidth:18,
            ...
            var image_list = ["playpauseimage", "stopimage", "prevnextimage", "loopimage", "volumeimage",
                "tracklistarrowimage", "Downloadimage"
            ];
